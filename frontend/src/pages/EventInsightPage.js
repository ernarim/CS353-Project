...
export function EventInsightPage() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <Row gutter={[16, 16]}>
        <Col span={16}>
          <Card style={{ boxShadow: '0 4px 8px 0 rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingTop: '20px' }}>
              <img src={`${baseURLEvents}${eventDetails.photo}`} alt="event" style={{ width: '60%', height: 'auto', objectFit: 'contain', borderRadius: '8px 8px 0 0' }} />
            </div>
            <div style={{ padding: '20px' }}>
          ...
          <Card style={{ marginTop: '16px', boxShadow: '0 4px 8px 0 rgba(0,0,0,0.1)', display: 'flex', flexDirection: 'column' }}>
            <div style={{ padding: '20px' }}>
        ...
        <Col span={8}>
          <Card style={{ padding: '20px', borderRadius: '8px', backgroundColor: 'white' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Statistic title="Total Available Seats" value={totalAvailableTickets} style={{ marginRight: '40px' }} />
            </div>
